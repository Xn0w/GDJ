...
public class SpringBeanConfig {
	...
	*/
	...
	public Song qwerty() {	// 메소드이름은 아무거나 적어도 된다.
		Song song = new Song();
		song.setTitle("제목2");
		song.setGenre("장르2");
		return song;
	...
	// setter injection
	@Bean(name="singer2")
	public Singer qwerty1() {
		Singer singer = new Singer();
		singer.setName("가수2");
		singer.setSong(qwerty());
		return singer;
	}
	// song3을 가지는 singer3을 만들어 보자.
	// constructor injection
	@Bean public Singer singer3() {
