...
--  JOIN 없이 EMPLOYEES 테이블만 이동하여 EMPLOYEE_ID, DEPARTMENT_NAME
SELECT
       EMPLOYEE_ID
...
-- EMPLOYEE_ID, PHONE_NUMBER, REGION 보고하기
...
-- EMPLOYEE ID, HIRE_DATE(YYYY-MM-DD) 근무개월수, 퇴직금정한대상유무 조회하기
-- 퇴직금정산대상: 근무개월수가 240개월에 이상하면 '정산대상', 아니면 빈 문자열
