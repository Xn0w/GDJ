...
BEGIN
    ...
    DELETE DEPARTMENT WHERE DEPTNO = DNO;
...
SELECT SNAME, DNAME, PNAME
   FROM STUDENT INNER JOIN DEPARTMENT
        ON STUDENT.DEPTNO = DEPARTMENT.DEPTNO INNER JOIN PROFESSOR
        ON DEPARTMENT.PROFNO = PROFESSOR.PROFNO;
