...
CREATE TABLE EMPLOYEE(
    EMP_NO NUMBER(1) NOT NULL,
    DEPT_NO VARCHAR2(15 BYTE) NULL,
    EMP_POS CHAR(10 BYTE) NULL,
...
-- 먼저 FK를 제거해야함
ALTER TABLE DEPARTMENT
    DROP CONSTRAINT PK_DEPARTMENT;  -- EMPLOYEE의 FK를 먼저 제거해야 실행가능
ALTER TABLE DEPARTMENT
    DROP PRIMARY KEY;
...
-- 먼저 FK를 제거해야 함
ALTER TABLE DEPARTMENT
    DROP CONSTRAINT PK_DEPARTMENT;  -- EMPLOYEE의 FK를 먼저 제거해야 한다.
-- ALTER TABLE DEPARTMENT
--     DROP PRIMARY KEY;
