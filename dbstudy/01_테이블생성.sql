...
/*
    CHAR(size) : 고정 길이 문자 타입(1 ~ 20000 바이트)
    VARCHAR2(size) : 가변 길이 문자 타입(1 ~ 4000 바이트)
...
/*
    제약조건 생성
    1. 테이블 생성할 때 함께 지정
    2. 테이블 생성한 뒤 테이블 수정하면서 지정 ㅡ> ALTER(DDL)
*/
...
-- 원하는 행을 블락 잡고 ctrl + enter시 해당 블록 실행
