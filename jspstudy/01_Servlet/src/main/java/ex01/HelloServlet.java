...
/*
	...
	4. URL
		프로토콜://호스트:포트번호:컨덱스트패스/URLMapping
		http://locathost:9090/01_Servlet/HelloServlet
...
public class HelloServlet extends HttpServlet {	// Servlet은 HttpServlet을 상속 받으면 된다.
	...
	*/
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// service 메소드가 존재하는 경우 doGET()/doPost가 자동으로 호출되지 않기 때문에
		// 코드를 직접 작성
		
		// 요청 메소드 확인 : request.getMethod()
		switch(request.getMethod()) {	// doGet() 메소드 호출
		case "GET":
